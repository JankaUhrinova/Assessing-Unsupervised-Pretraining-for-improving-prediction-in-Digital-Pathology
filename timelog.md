...
* *3 hours* debugging the DCGAN

### 30 Nov 2022

* *2 hours* writing the status report

## Week 13

### 9 Jan 2023

* *5 hours* writing the Introduction of dissertation

### 10 Jan 2023

* *3 hours* completing the DCGAN (not working properly yet)
...
* *6 hours* finishing the working version of DCGAN on MNIST

### 17 Jan 2023

* *5 hours* working on ConvNet on MNIST
...
* *5 hours* Finishing the working ConvNet on MNIST
...
* *2 hours* reading on the possible datasets that can be used to evaluate the project

### 31 Jan 2023

* *3 hours* Writing the disscussion on the datadet for the dissertation
...
* *4 hours* downloading the dataset and uploading to the drive

### 14 Feb 2023

* *4 hours* converting the dataset to arrays
...
* *5 hours* writing up the dissertation
...
* *2 hours* loading up the dataset and learning how to split it
* *2 hours* test run of the DCGAN on the samples from the dataset

### 28 Feb 2023

* *2 hours* writing up a dissertation
